export const servicesContent = {
  ...
  intro:
    "Marss prefers to use products when possible that innovate sustainably by taking inspiration from nature and promote organic farming and encourage agro-ecology (René Furterer).",
  part1: {
